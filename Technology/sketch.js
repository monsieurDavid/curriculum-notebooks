...
function setup() {
    ...
    n_button = select('#button');
    n_button.mousePressed(moveIndx_f);
    
    b_button = select('#button2');
    b_button.mousePressed(moveIndx_b);
